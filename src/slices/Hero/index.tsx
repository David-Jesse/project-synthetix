      ...
      <div className="relative flex w-full flex-col items-center justify-center gap-4 min-[425px]:w-[400px] md:w-full lg:w-[760px] xl:w-[1090px]">
        ...
        >
          <Linker
            ...
            className="transition-some inline-flex w-full justify-center rounded-full bg-gradient-to-b from-[#ff6d00]/10 to-[#ff6d00]/[50%] px-7 py-4 text-base leading-[23.04px] tracking-[-0.16px] text-white outline-2 -outline-offset-[2px] outline-white/[12%] backdrop-blur-[50px] duration-300 hover:bg-[#ff6d00]/60 md:w-max"
          />
          <Linker
            field={slice.primary.services_button}
            className="transition-some inline-flex w-full justify-center rounded-full bg-gradient-to-b from-white/[5%] to-white/[15%] px-7 py-4 text-base leading-[23.04px] tracking-[-0.16px] text-white outline-2 -outline-offset-[2px] outline-white/[12%] backdrop-blur-[50px] duration-300 hover:!bg-[#ff]/[12%] md:w-max"
          />
        </motion.div>
        ...
        <div className="mb-12 mt-[120px] flex w-full flex-col items-center justify-center gap-8 md:mb-[56px] md:mt-[243px]">
          <h4 className="w-[240px] text-center tex-[12px] font-medium leading-[17.28px] tracking-[0.72px] text-white sm:w-full">
