...
/**
 * Component props for `ContactUs`.
 */
export type ContactUsProps = SliceComponentProps<Content.ContactUsSlice>;

/**
 * A component that displays a contact us section.
 */
  ...
  return (
    ...
    >
      <div className="flex w-full flex-col items-start justify-start 2xl:max-w-[1440px]">
        ...
        <div className="mt-4 text-left text-[32px] leading-[34.56px] tracking-[-1.12px] sm:w-[400px] md:w-[648px] md:text-balance md:text-[52px] md:leading-[56.16px] xl:text-[56px] xl:leading-[60.48px]">
          CONTACT US
        </div>
      ...
      <div className="flex w-full flex-col gap-4 xl:flex-row xl:pt-16 2xl:max-w-[1440px]">
        ...
        >
          <div className="mt-16 grid w-full grid-cols-1 grid-row-4 place-content-center place-items-center gap-x-[40px] gap-y-[40px] rounded-2xl bg-gradient-to-b from-[#ff6d00]/[0.05] to-[#ff6d00]/[0.25] px-6 py-10 outline-2 -outline-offset-[2px] outline-white/[12%] backdrop-blur-[50px] sm:grid-rows-2 xl:mt-0 xl:px-10 xl:py-12">
          ...
          <div className="flex w-fulll flex-col rounded-2xl bg-gradient-to-b from-[#fff]/[0.05] to-[#fff]/[0.15] px-6 py-10 outline-2 -outline-offset-[2px] outline-white/[12%]  backdrop-blur-[50px] md:px-10 md:py-12 xl:mt-0 xl:py-12">
            <h5 className="text-[12px] font-medium leading-[17.28px] tracking-[0.72px] opacity-50">
        ...
        >
          <PrismicNextImage
            ...
            className="w-full rounded-2xl object-cover outline-2 -outline-offset-[2px] outline-white/[12px] xl:h-[849px] xl:w-[687px]"
          />
        </motion.div>
      </div>
    </section>
