...
const Navbar = ({ settings }: NavbarProps) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="flex h-[54px] w-[54px] cursor-pointer flex-col items-center justify-center gap-1 rounded-full bg-gradient-to-b from-white/[5%] to-white/[15%] outline-2 outline-white/[12%] backdrop-blur-[50px] transition-all duration-300 hover:bg-white/[12%]"
      ...
      >
        <div className="flex h-[54px] w-[54px] items-center justify-center rounded-full bg-gradient-to-b from-[#fff6d00]/10 to-[#ff6d00]/[50%] outline-2 -outline-offset-[2px] outline-white/[12%] backdrop-blur-[50px] transition-all duration-300 hover:bg-[#ff6d00]/60">
          <Image
            src={Logo}
            alt="logo"
            width={300}
      ...
      <Link
        href={"/#contact-us"}
        onClick={handleScroll}
        className="hidden rounded-full bg-gradient-to-b from-white/[5%] to-white/[15%] px-7 py-4 text-base leading-[23.04px] tracking-[-0.16px] text-white outline-2 -outline-offset-[2px] outline-white/[12%] backdrop-blur-[50px] hover:bg-white/[12%] md:block"
      >
        Contact Us
      </Link>
